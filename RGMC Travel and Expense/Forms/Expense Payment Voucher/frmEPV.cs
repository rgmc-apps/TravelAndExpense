...
namespace MyRIS
{
    public partial class frmEPV : Form
    {
        ...
        private void FilterList()
        {
            try
            {
                ...
                dgvList.Columns["epvId"].Visible = false;
                dgvList.Columns["chargeToId"].Visible = false;
                dgvList.Columns["epvStatusId"].Visible = false;

                dgvList.Columns["CA Amount"].DefaultCellStyle.Format = "₱ ##,###.00";
                dgvList.Columns["Total Expense"].DefaultCellStyle.Format = "₱ ##,###.00";
                dgvList.Columns["Cash Under/(Over)"].DefaultCellStyle.Format = "₱#,###.00;(₱#,###.00);0";
            }
            catch (Exception ex)
        ...
        public void ExecuteSQL()
        {
            ...
            try
            {
                ...
                System.Data.SqlClient.SqlParameter pTransactionTypeId = new System.Data.SqlClient.SqlParameter("@transactionTypeId", SqlDbType.Int);
                pTransactionTypeId.Value = cboTransactionType.SelectedValue;
                ...
                { mvAllDT = sql.GetDT(sSQL, CommandType.StoredProcedure, pChargeToId, pEmployeeId, pTransactionTypeId, pStartDate, pEndDate, pStatusId, pHeadEmployeeId); }

                mvAllDT.TableName = "EPV";

                mvSortBy = "[Request Date]";
            ...
            { function.MsgBoxInfo(this.Text, "EPV Table is Missing"); }
        }
        ...
        private void frmEPV_Load(object sender, EventArgs e)
        {           
        ...
        private void dgvList_DoubleClick(object sender, EventArgs e)
        {
            try
            {
                ...
                frm.EPVId = Convert.ToInt32(strItemID);
        ...
        private void btnSearchItemID_Click(object sender, EventArgs e)
        {
            ...
            string filterData = "[EPV #] LIKE " + ("%" + strData + "%").sQuote()

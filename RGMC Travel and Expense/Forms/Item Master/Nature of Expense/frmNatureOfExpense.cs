...
namespace MyRIS
{
    public partial class frmNatureOfExpense : Form
    {
        ...
        private void LoadDataGridView()
        {
            ...
            DataGridViewColumnFormat(dgrid, 0, "NatureOfExpense ID", 0, false);
        ...
        private void ExecuteSQL()
        {
            ...
            try
            {
                sSQL.AppendLine("SELECT natureOfExpenseId, natureOfExpenseName AS Name, natureOfExpenseCode AS Code, remark,");
        ...
        private void ShowDetail(string strCommand)
        {
            ...
            try
            {
                ...
                frmNatureOfExpenseDetail frm = new frmNatureOfExpenseDetail();

                frm.NatureOfExpenseId = lngId;
                frm.ShowDialog();

                if (frm.DialogResult == DialogResult.OK)
                {
                    ExecuteSQL();
                    findDgridItem(frm.NatureOfExpenseName);
                }
        ...
        private void frmNatureOfExpense_Load(object sender, EventArgs e)
        {
            ExecuteSQL();
        }

...
namespace MyRIS
{
    public partial class frmBusinessPurpose : Form
    {
        ...
        private void LoadDataGridView()
        {
            ...
            DataGridViewColumnFormat(dgrid, 0, "BusinessPurpose ID", 0, false);
        ...
        private void ExecuteSQL()
        {
            ...
            try
            {
                sSQL.AppendLine("SELECT businessPurposeId, businessPurposeName AS Name, businessPurposeCode AS Code, remark,");
        ...
        private void ShowDetail(string strCommand)
        {
            ...
            try
            {
                ...
                frmBusinessPurposeDetail frm = new frmBusinessPurposeDetail();

                frm.BusinessPurposeId = lngId;
                frm.ShowDialog();

                if (frm.DialogResult == DialogResult.OK)
                {
                    ExecuteSQL();
                    findDgridItem(frm.BusinessPurposeName);
                }
        ...
        private void frmBusinessPurpose_Load(object sender, EventArgs e)
        {
            ExecuteSQL();
        }

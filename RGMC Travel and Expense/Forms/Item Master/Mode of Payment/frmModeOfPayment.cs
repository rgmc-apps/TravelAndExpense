...
namespace MyRIS
{
    public partial class frmModeOfPayment : Form
    {
        ...
        private void LoadDataGridView()
        {
            ...
            DataGridViewColumnFormat(dgrid, 0, "ModeOfPayment ID", 0, false);
        ...
        private void ExecuteSQL()
        {
            ...
            try
            {
                sSQL.AppendLine("SELECT modeOfPaymentId, modeOfPaymentName AS Name, modeOfPaymentCode AS Code, remark,");
        ...
        private void ShowDetail(string strCommand)
        {
            ...
            try
            {
                ...
                frmModeOfPaymentDetail frm = new frmModeOfPaymentDetail();

                frm.ModeOfPaymentId = lngId;
                frm.ShowDialog();

                if (frm.DialogResult == DialogResult.OK)
                {
                    ExecuteSQL();
                    findDgridItem(frm.ModeOfPaymentName);
                }

...
namespace MyRIS
{
    public partial class frmModeOfTransportation : Form
    {
        ...
        public frmModeOfTransportation()
        {
            InitializeComponent();
        }
        ...
        private void LoadDataGridView()
        {
            ...
            DataGridViewColumnFormat(dgrid, 0, "ModeOfTransportation ID", 0, false);
        ...
        private void ExecuteSQL()
        {
            ...
            try
            {
                sSQL.AppendLine("SELECT modeOfTranspoId, modeOfTranspoName AS Name, modeOfTranspoCode AS Code, remark,");
        ...
        private void ShowDetail(string strCommand)
        {
            ...
            try
            {
                ...
                frmModeOfTransportationDetail frm = new frmModeOfTransportationDetail();

                frm.ModeOfTransportationId = lngId;
                frm.ShowDialog();

                if (frm.DialogResult == DialogResult.OK)
                {
                    ExecuteSQL();
                    findDgridItem(frm.ModeOfTransportationName);
                }
        ...
        private void frmModeOfTransportation_Load(object sender, EventArgs e)
        {
            ExecuteSQL();
        }

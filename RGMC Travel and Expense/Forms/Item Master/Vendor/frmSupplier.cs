...
namespace MyRIS
{
    public partial class frmSupplier : Form
    {
        ...
        private void LoadDataGridView()
        {
            ...
            DataGridViewColumnFormat(dgrid, 0, "Vendor ID", 0, false);
            DataGridViewColumnFormat(dgrid, 1, "Vendor", 350);
            DataGridViewColumnFormat(dgrid, 2, "TIN", 150);
            DataGridViewColumnFormat(dgrid, 3, "Address", 400);
            DataGridViewColumnFormat(dgrid, 4, "Remark", 250);
            DataGridViewColumnFormat(dgrid, 5, "Is Active?", 100);
            DataGridViewColumnFormat(dgrid, 6, "Updated By", 100);
            DataGridViewColumnFormat(dgrid, 7, "Updated Date", 150);
        }
        ...
        private void ExecuteSQL()
        {
            ...
            try
            {
                sSQL.AppendLine("SELECT vendorId, vendorName, tin, address, remark,");
        ...
        private void ShowDetail(string strCommand)
        {
            ...
            try
            {
                ...
                {
                    ExecuteSQL();
                    findDgridItem(frm.SupplierName);
                }
        ...
        private void btnSearch_Click(object sender, EventArgs e)
        {
            ...
            string filterData = "[vendorName] LIKE " + ("%" + strData + "%").sQuote()
                    + " OR [Address] LIKE " + ("%" + strData + "%").sQuote()
                    + " OR [TIN] LIKE " + ("%" + strData + "%").sQuote();

...
namespace MyRIS
{
    public partial class frmEPVStatusMonitoring : Form
    {

        private Common common = new Common();
        private Function function = new Function();

        public frmEPVStatusMonitoring()
        {
            InitializeComponent();
        }
        ...
        private void ExecuteReport(ref LocalReport report)
        {
            ...
            string sSQL = "proc_RPT10EPVStatusMonitoring";
            ...
            try
            {
                ...
                report.ReportEmbeddedResource = "MyRIS.Reports.rptEPVStatusMonitoring.rdlc"; // bind reportviewer with .rdlc  
                report.DisplayName = "EPV Status Monitoring";

                //report.SubreportProcessing += new
                //SubreportProcessingEventHandler(SetSubDataSource);

                ReportDataSource ds = new ReportDataSource("EPVStatusMonitoring", dt); // set the datasource

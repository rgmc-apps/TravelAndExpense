...
namespace MyRIS
{
    public partial class frmTopSheetForReimbursement : Form
    {
        private Common common = new Common();
        private Function function = new Function();

        string FileName = "TopSheetReimbursement_" + string.Format("{0:MMddyy}", DateTime.Now);

        public frmTopSheetForReimbursement()
        {
            InitializeComponent();
        }
        ...
        private void ExecuteReport(ref LocalReport report)
        {
            ...
            string sSQL = "proc_RPT08TopSheetReimbursement";
            ...
            try
            {
                ...
                report.ReportEmbeddedResource = "MyRIS.Reports.rptTopSheetReimbursement.rdlc"; // bind reportviewer with .rdlc  
                report.DisplayName = "Top Sheet For Reimbursement";
                ...
                {
                    dt.Rows.Add(rowCount + i,"-", DateTime.Today, DateTime.Today,"-","-","-","-","-","-","-","-","-","-","-", 0);
                }

                ReportDataSource ds = new ReportDataSource("TopSheetReimbursement", dt); // set the datasource
        ...
        private void frmTopSheetForReimbursement_Load(object sender, EventArgs e)
        {
